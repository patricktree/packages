...
type DebounceResult<ThisType, Params extends unknown[]> = [
  (this: ThisType, ...params: Params) => unknown,
  () => void,
];

function debounce<ThisType, Params extends unknown[]>(
  fn: (this: ThisType, ...params: Params) => unknown,
  limit: number,
): DebounceResult<ThisType, Params> {
  let lastFnInvocation: undefined | (() => void) = undefined;
  let scheduledTimeoutId: undefined | ReturnType<typeof setTimeout> = undefined;
...
type ThrottleResult<ThisType, Params extends unknown[]> = [
  (this: ThisType, ...params: Params) => unknown,
  () => void,
];

// based on "non-configurable version" from https://stackoverflow.com/a/27078401/1700319
function throttle<ThisType, Params extends unknown[]>(
  fn: (this: ThisType, ...params: Params) => unknown,
  limit: number,
